...
def parse_args():
    parser = argparse.ArgumentParser(description="Split lightbox test.json into train/validation")
    base_default = Path("/home/user-wwy/Dataset/speed-lightbox/")
    parser.add_argument("--input", type=Path, default=base_default / "test.json",
                        help="Path to source JSON (default: /home/user-wwy/Dataset/speed-lightbox/test.json)")
